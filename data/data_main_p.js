...
const textOfMethodMaterials = [
    ...
    `<p class='pink_subtitle'>Рекомендации для преподавателя</p>
    <p class='none_list'>В данном ЭОМ размещены материалы для практических работ по темам: ПР №1 Определение дефектов зубчатых колёс с помощью измерения и визуально</p>
...
Система \n это совокупность правильно расположенных и взаимосвязанных между собой частей, выполняющих в механизме определенную функцию. Например, смазочная система.
...
Дефект \n это каждое отдельное несоответствие продукции (машины, узла, детали) требованиям, установленным конструкторской (проектной) и/или нормативной документацией.
...
Смазывание \n это процесс нанесения маслянистых или консистентных смазочных материалов, направленный на уменьшение трения и обеспечение плавного скольжения движущихся деталей машины относительно друг друга.`
/* 1) ФГОС СПО
