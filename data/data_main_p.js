...
const textOfMethodMaterials = [
    ...
    <p class='pink_subtitle'>Рекомендации для преподавателя</p>
    <p class='none_list'>В данном ЭОМ размещены материалы для практических работ по темам: <br><br> ПР №1 Определение дефектов зубчатых колёс с помощью измерения и визуально</p>
