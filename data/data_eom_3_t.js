...
const data = {
    ...
    "index_10":{
        ...
        "test": [{
            ...
            "test_with_text_2": "Средство защиты органов дыхания, {=респиратор}<br> Средство защиты органов слуха, {=наушники}<br> Средство защиты головы, каска {=каска}."
        }, {
            "image": true,
    ...
    "index_14":{
        ...
        "test":[
            ...
            {"correct_answer_type_10": [1,2,3,4,5]}
        ],
    },
    "index_15":{
        ...
        "test": [{
            ...
            "answersInCol": [['Уменьшение вязкости гидравлического масла вследствие его сильного нагрева'], ['Улучшить условия охлаждения масла', 'Заменить гидравлическую жидкость на масло большей вязкости']]
        }, {
            "columns": ['Возможная причина', 'Способ устранения']
        }],
    },
    "index_16":{
        "subtitle": "Результаты",
